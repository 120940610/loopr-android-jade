...
import com.loopr.wallet.wallet.manager.PasswordManager;
import com.loopr.wallet.wallet.util.KS;
import java.security.SecureRandom;
import java.util.Map;
import io.reactivex.Completable;
import io.reactivex.Single;

public class WalletPasswordStore implements PasswordStore {

	private final Context context;

	public WalletPasswordStore(Context context) {
